...
var path_from1 = "res://World/MVP_Suburb/2_1.tscn"
var path_from2 = "res://World/MVP_Suburb/4_1.tscn"
var path_from3 = "res://World/MVP_Suburb/3_2.tscn"

# Called when the node enters the scene tree for the first time.
func _ready():
	# Spawn zombies/crates if not spawned yet
	if not WorldFlags.entities_spawned_suburb_3_1:
		spawn_zombies(4)
		spawn_crates(1)
		WorldFlags.entities_spawned_suburb_3_1 = true
	move_to_position()
