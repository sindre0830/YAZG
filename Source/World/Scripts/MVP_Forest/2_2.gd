...
var path_from1 = "res://World/MVP_Forest/1_2.tscn"
var path_from2 = "res://World/MVP_Forest/3_2.tscn"
var path_from3 = "res://World/MVP_Forest/2_3.tscn"

# Called when the node enters the scene tree for the first time.
func _ready():
	# Spawn zombies/crates if not spawned yet
	if not WorldFlags.entities_spawned_forest_2_2:
		spawn_zombies(4)
		WorldFlags.entities_spawned_forest_2_2 = true
	move_to_position()
